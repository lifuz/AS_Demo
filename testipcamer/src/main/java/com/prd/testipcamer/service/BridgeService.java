package com.prd.testipcamer.service;
...
import com.prd.testipcamer.PlayBackActivity;
import com.prd.testipcamer.R;
...
//		}
    ...
    public void CallBackAlermMessage(String did, String name, int headcmd,
        ...
        if (selfcmd == ContentCommon.SENSOR_ALARM_ACTION_ALARM && sensoraction == 8) {// 对码返回
