...
public class UpdateAppManager {
    ...
    // 外存sdcard存放路径
    private static final String FILE_PATH = Environment.getExternalStorageDirectory() + FILE_SEPARATOR + "prd" + FILE_SEPARATOR;
    // 下载应用存放全路径
    private static final String FILE_NAME = FILE_PATH + "yzy.apk";
    // 更新应用版本标记
    ...
    // 以华为天天聊hotalk.apk为例
    private String spec = "http://prd.hhzn.cn/prd/yzy.apk";
    // 下载应用的对话框
